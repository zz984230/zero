...
from usecase.login.login_uc import LoginUc
...
from presenter.login_pt import LoginPt
import fire
...
class Program(object):
    ...
    def __init(self):
        ...
        self.__global_pt = GlobalPt(self.__cfg.logo_file, self.__cfg.bg_file, balance_pt, valuation_pt, cloud_pt, financial_pt, login_pt).set_global_layout().set_left_layout().render()

        self.__login_uc = LoginUc(login_pt)
